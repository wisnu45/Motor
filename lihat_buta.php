...
<div id="wrapper">
<!--------------- #header --------------->
 <div id="header"><p><img src="images/cm.jpg" alt="" width="790" height="129" /></p>
 <div>
<strong><marquee direction="left"><font color="#FF0000" size="2">
 <script>
	<!--//
  var d = new Date();
  var h = d.getHours();
...
</script></font></marquee></strong></div></td></p></div><marquee behavior="alternate"></marquee>
<!--------------- #menu --------------->
...
if (1 != $paging){
	$back=$paging-1;
	echo "<div id='kotak-paging'><a href='lihat_buta.php?paging=$back'><b>Back</b></a></div>";
	}
	else{
...
if ($paging != $jumlah_halaman){
	$next=$paging+1;
	echo" <div id='kotak-paging'><a href='lihat_buta.php?paging=$next'>  <b>Next</b></a></div>";
	}
	else
	{
